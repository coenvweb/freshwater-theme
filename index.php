...
get_header(); // Loads the header.php template. ?>
	...
	<div class="content-wrap">
		...
		<div id="content">
			...
			<div class="hfeed">
                <?php query_posts( array( 'category__not_in' => array(4,9,8,7) ) ); ?>
					...
					<?php while ( have_posts() ) : the_post(); ?>
						...
						<?php do_atomic( 'before_entry' ); // oxygen_before_entry ?>
							...
							<?php if ( current_theme_supports( 'get-the-image' ) ) {
								...
								get_the_image( array( 'meta_key' => 'Thumbnail', 'size' => 'archive-thumbnail', 'image_class' => 'featured', 'width' => 590, 'height' => 140, 'default_image' => get_template_directory_uri() . '/images/archive-thumbnail-placeholder.gif' ) );							
